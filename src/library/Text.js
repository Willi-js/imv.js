...
export default class Text {
    constructor(width = 100, height = 20, x = 0, y = 0, text = 'Hello, World', color = 'black',fontSize = 15, fontFamily = 'Arial, Helvetica, sans-serif', apped_to = Root.getRoot()) {
        ...
        // parent
        this.parent = apped_to;
        // ID & classes
        this.ID = this.ID = 200000000000000 + Math.floor(Math.random()*9999999999999);
        this.class = [];
        // directions
        this.directionX = 'r';
        this.directionY = 'b';
    ...
    draw() {
        if(!this.isOnScreen) {
            ...
            this.object.textContent = this.text;
            this.object.style.color = this.color;
            this.object.style.fontSize = `${this.fontSize}px`;
            this.object.style.fontFamily = this.fontFamily;
            this.object.style.width = `${this.width}px`;
            this.object.style.height = `${this.height}px`;
            this.object.style.position = 'absolute';
            this.object.style.top = `${this.y}px`;
            this.object.style.left = `${this.x}px`;
            this.object.style.margin = 0;
    ...
    changeFontFamily(newFontFamily = 'Arial, Helvetica, sans-serif') {
    ...
    check_collision() {
        ...
        var allEllements = this.parent.children;
